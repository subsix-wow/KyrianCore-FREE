...
public:
    ...
    void QuestReward(Player* player, Quest const* quest, LootItemType type, uint32 opt) override;    //bool sOnDummyEffect(Unit* caster, uint32 spellId, SpellEffIndex effIndex) override;
