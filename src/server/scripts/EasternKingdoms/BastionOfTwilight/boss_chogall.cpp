...
public:
    ...
    {
        npc_chogall_corruptionAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
...
public:
    ...
    {
        npc_chogall_fire_portalAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE));
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NOT_SELECTABLE));
            me->SetReactState(REACT_PASSIVE);
...
public:
    ...
    {
        npc_chogall_malformationAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE));
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NOT_SELECTABLE));
            instance = pCreature->GetInstanceScript();
...
public:
    ...
    {
        npc_chogall_shadow_portalAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE));
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_NOT_SELECTABLE));
            me->SetReactState(REACT_PASSIVE);
