                    ...
                    case eSpells::BustLoose:
                    {
                      ...
                      //  {
                           // Position const l_TeleportPos = { 197.707f, 3529.08f, 217.234f, me->GetOrientation() };
                            ...
                            me->CastSpell(eSpells::BustLooseSecond, true);
                      //  });
                      ...
                      //  {
                            ...
                            me->CastSpell(eSpells::SlagPoolAreatrigger, true);
                       // });
    ...
    public:
        ...
        struct go_foundry_crucibleAI : public GameObjectAI
        {
            ...
            void Reset() override
            {
                ...
                GameObject* l_CrucibleSec = me->FindNearestGameObject(eGameObjects::CrucibleSecLeft, 50.0f);
                if (l_CrucibleSec == nullptr)
                    l_CrucibleSec = me->FindNearestGameObject(eGameObjects::CrucibleSecRight, 50.0f);
                ...
                if (l_CrucibleSec != nullptr)
                {
                  ...
                  //  AddTimedDelayedOperation(l_Time, [this, l_Guid]() -> void
                   // {
                        if (GameObject* l_CrucibleSec =ObjectAccessor::GetGameObject(*me, l_Guid))
                   ...
                   // {
                        /// End animation
                        me->SetGoState(GOState::GO_STATE_READY);
                   // });
                }
            }
