            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                if (m_Instance)
                {
                    ...
                    /*if (sObjectMgr->IsDisabledEncounter(m_Instance->GetEncounterIDForBoss(me), GetDifficulty()))
                        ...
                        instance->DoCastSpellOnPlayers(eSpells::KargathBonusLoot);
            ...
            void DoAction(int32 const action) override
            {
                switch (action)
                {
                    ...
                    case eActions::InterruptByPillar:
                    {
                        ...
                        AddTimedDelayedOperation(1 * TimeConstants::IN_MILLISECONDS, [this]() -> void
                        {
                          //  if (Unit* l_NewTarget = me->GetThreatManager().IsEngaged())
        ...
        class spell_highmaul_earth_breaker_SpellScript : public SpellScript
        {
            ...
            void HandleBeforeCast()
            {
                if (Unit* caster = GetCaster())
                {
                    ...
                    caster->CastSpell(eDatas::EarthMissile, true);
...
public:
    ...
    void OnUnitEnter(Unit* unit) override
    {
        ...
        if (!unit->IsOnVehicle(unit) && unit->GetEntry() != eHighmaulCreatures::KargathBladefist)
    ...
    void OnUpdate(uint32 /*diff*/) override
    {
        ...
        for (ObjectGuid insideUnit : insideUnits)
        {
            if (Unit* l_Unit = ObjectAccessor::GetUnit(*at->GetCaster(), insideUnit))
                if (l_Unit->IsOnVehicle(l_Unit) || l_Unit->HasAura(eSpells::Obscured))
