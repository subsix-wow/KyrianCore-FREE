        ...
        struct boss_the_butcherAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                if (m_Instance != nullptr)
                {
                    ...
                    instance->DoCastSpellOnPlayers(eSpells::ButcherBonusLoot);
            ...
            void SpellMissTarget(Unit* target, SpellInfo* spellInfo, SpellMissInfo missInfo) //override
            {
                if (target == nullptr)
                    return;
            ...
            void OnSpellCasted(SpellInfo* spellInfo) //override
            {
