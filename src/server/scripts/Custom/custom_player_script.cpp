...
/* KyrianCore Free Repack Welcome message */
/*class KyrianCoreFreeRepackWelcome : public PlayerScript
{
public:
    KyrianCoreFreeRepackWelcome() : PlayerScript("KyrianCoreFreeRepackWelcome") { }
    ...
    {
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000 This is KyrianCore Free Test Repack. Donate to remove ads and limitations|r");
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000 KyrianCore official discord: https://discord.gg/57D59ed KyrianCoreTeam@yahoo.com|r");
        player->GetSession()->SendNotification("This is KyrianCore Free Test Repack. Donate to remove ads and limitations. KyrianCore official discord: https://discord.gg/57D59ed KyrianCoreTeam@yahoo.com");
    }
};*/
...
void AddSC_custom_player_script()
{
    ...
    //RegisterPlayerScript(KyrianCoreFreeRepackWelcome);
}
